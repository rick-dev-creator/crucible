...
public interface IOrderSnapshot
{
    ...
    long Version { get; }
    global::System.Collections.Generic.IReadOnlyList<global::Sample.IOrderItemSnapshot> Items { get; }
}
...
public partial class Order
{
    ...
    internal void __HydrateFromSnapshot(IOrderSnapshot snapshot)
    {
        ...
        this._items.Clear();
        foreach (var __child in snapshot.Items)
        {
            this._items.Add(global::Sample.OrderItem.RehydrateFrom(__child));
        }
    }
}
